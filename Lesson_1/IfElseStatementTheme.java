public class IfElseStatementTheme {
    public static void main(String[] args) {
        ...
        if (age > 20) {
            System.out.println("Думаю, тебе больше 20");
        } else {
        ...
        if (height < 1.8) {
            System.out.println("Ещё не вырос");
        } else {
            System.out.println("Вот это рост!");
        }
        ...
        if (firtstLetterOfName == 'M') {
            ...
            System.out.println("Думаю, твое имя начинается на букву I");
        } else {
            System.out.println("Не удалось угадать(");
        }
